...
import cn.wander.Utils.views.flingswipe.SwipeFlingAdapterView;
 ...
 */
public class EncounterActivity extends BaseActivity implements SwipeFlingAdapterView.onFlingListener, SwipeFlingAdapterView.OnItemClickListener {
    ...
    String[] names = {"相互匹配可成为知音", "提供评论入口", "作品的热度", "提高作品的曝光度", "打赏模式", "展现自己", "点击进入详情"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view = LayoutInflater.from(this).inflate(R.layout.encounter_activity, null, false);
        setView(view);
    ...
    private class InnerAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            ImageLoader.getInstance().displayImage(talent.headerIcon, holder.portraitView, options);
